...
<?php echo ( $currentmonth != $datefmt->format($event->Start, $monthyear) ) ? '</div><div class="row justify-content-center"><h2 class="text-center my-4">' . $datefmt->format($event->Start, $monthyear) . '</h2>' : '' ?>
