...
function bootscore_swiper_hero( $atts ) {
	...
	$options = array(
		'post_type' => explode( ',', $type ), // added explode for post_type
		'order' => $order,
		'orderby' => $orderby,
            ...
            <div class="position-absolute top-0 end-0 bottom-0 start-0">
                ...
                <div class="container h-100 d-flex flex-column">
                    ...
                    <div class="mt-auto text-white mb-5 text-center">
                        ...
                        <?php bootscore_category_badge( true ); ?>
                        ...
                        <div class="card-text">
                            <?php // the_excerpt(); // i dont want the excerpt within slider ?>
                        </div>
                        <?php
                        /* <a class="read-more btn btn-outline-light btn-sm" href="<?php the_permalink(); ?>"><?php _e('Read more »', 'bootscore'); ?></a> */ // realy ugly within slider ...
			?>
                        <!-- Tags -->
                        <?php // bootscore_tags(); // i dont want tags within slider ?>
